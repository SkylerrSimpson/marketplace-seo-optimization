...
/**
 * fetch_all_category_upc_support.php — Ethan's specific ask, 2026-07-09: a list of
 ...
 * NOTE (2026-07-09, per Ethan): despite the earlier docblock wording here, "required"
...
for ($i = 0; $i < count($leaves); $i += $batchSize) {
    ...
    $done += count($batch);
    if ($done % 400 === 0 || $done === count($leaves)) {
