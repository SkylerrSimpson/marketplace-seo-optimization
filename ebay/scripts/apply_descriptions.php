 ...
 * one of yes/y/true/1/approved/approve (case-insensitive, trimmed). This is Ethan's
...
if (!$approvedSet) {
    fwrite(STDERR, "no approved rows in {$reviewPath} ({$totalRows} total rows scanned) — nothing to write. "
        . "Fill the 'approved' column (yes/y/true/1/approved/approve) once Ethan's review comes back.\n");
    exit(1);
}
