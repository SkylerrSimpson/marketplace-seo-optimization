...
/**
 * Shared bootstrap for all marketplace tooling. Lives at marketplaces/lib/, so
 * REPO_ROOT is two levels up (for vendor/ + .env, which stay at the repo root)
 * and the per-marketplace data dirs live under marketplaces/.
 *
...
define('REPO_ROOT', dirname(__DIR__, 2));          // repo root: vendor/, .env
define('MARKETPLACES_ROOT', dirname(__DIR__));      // marketplaces/: the per-marketplace tooling
...
define('SHOPIFY_DATA',   MARKETPLACES_ROOT . '/shopify/data');
...
// --- Amazon directories ------------------------------------------------------
define('AMAZON_ROOT',    MARKETPLACES_ROOT . '/amazon');
...
// eBay is PER-ACCOUNT (DOWS, IGE, ...), mirroring the amazon/data/{account} layout.
...
define('EBAY_DATA',    MARKETPLACES_ROOT . '/ebay/data');
...
define('WALMART_DATA', MARKETPLACES_ROOT . '/walmart/data');
