 ...
 *
 * Pushes the exact item/sku/aspect/final_value rows in the test file
 * (data/<acct>/output/canary_test_ids.csv) to eBay via Trading ReviseItem, one
 * listing at a time. Each test item was hand-picked to probe a
 ...
 *     because rewriting a variation-defining value is exactly how we lose
 *     sales history.
